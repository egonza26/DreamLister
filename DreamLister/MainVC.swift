...
class MainVC: UIViewController, UITableViewDelegate, UITableViewDataSource, NSFetchedResultsControllerDelegate {
    ...
    // Help to display data fetching from CoreData
    ...
    // Call it only the first time that runs the app to populate the DB 
    func genereteTestData() {
        ...
        item2.price = 300
        item2.details = "But man, its so nice to be able to block out everyone with the noise cancelig tech"
